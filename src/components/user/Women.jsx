...
import womenbgi from "../../assets/images/womenbgi.jpg";
...
{/* Banner */}
    ...
    <div className="w-full h-64 bg-cover bg-center" style={{backgroundImage:`url(${womenbgi})`}}/>
...
{/* Brand */}
    ...
    <div className="mb-5">
        ...
        <label className="block"><input type="checkbox"/> Kurti</label>
        <label className="block"><input type="checkbox"/> Dress</label>
        <label className="block"><input type="checkbox"/> Jeans</label>
        <label className="block"><input type="checkbox"/> Tops</label>
...
{/* Size */}
    ...
    <div className="flex justify-between items-center mt-3">
       ...
       <div>
  <button onClick={(e) => { navigate("/user/cartpage"); }}>
    Add To Cart
  </button>
</div>
